...
class Transformer(nn.Module):
    def __init__(self,
                 ...
                 max_seq_len: int = 120):
        super().__init__()
        self.encoder = Encoder(src_vocab_size, pad_idx, d_model,heads,
                               d_ff, n_layers, dropout, max_seq_len)
        self.decoder = Decoder(src_vocab_size, pad_idx, d_model, d_ff,
    ...
    def generate_mask(self,
        ...
        assert q_pad.shape == k_pad.shape
        n, q_len = q_pad.shape
        n, k_len = k_pad.shape
